...
const Pars = (props) => {
    ...
    return (
        <ListGroup variant="flush">
            <ListGroup.Item variant="dark">Total Pars: {getParTotal()}</ListGroup.Item>
            <ListGroup.Item variant="dark">Pars Per Round: {getParsPerRound()}</ListGroup.Item>
            <ListGroup.Item variant="dark">Pars Likelihood {getParLikelihood()}</ListGroup.Item>
        </ListGroup>
    )
}
