...
const DoubleBogeys = (props) => {
    ...
    return (
        <ListGroup variant="flush">
            <ListGroup.Item variant="dark">Total Double Bogeys: {getDoubleBogeyTotal()}</ListGroup.Item>
            <ListGroup.Item variant="dark">Double Bogey Per Round: {getDoubleBogeysPerRound()}</ListGroup.Item>
            <ListGroup.Item variant="dark">Double Bogey Likelihood {getDoubleLikelihood()}</ListGroup.Item>
        </ListGroup>
        )
}
