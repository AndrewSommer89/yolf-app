...
const TotalPutts = (props) => {
    ...
    return (
        <ListGroup variant="flush">
            <ListGroup.Item variant="dark">Total Putts: {getPuttsTotal()}</ListGroup.Item>
            <ListGroup.Item variant="dark">Putts Per Round: {getPuttsPerRound()}</ListGroup.Item>
            <ListGroup.Item variant="dark">Putts Per Hole: {getPuttsPerHole()}</ListGroup.Item>
        </ListGroup>
    )
}
