...
const Eagles = (props) => {
    ...
    return (
        <ListGroup variant="flush">
            <ListGroup.Item variant="dark">Total Eagles: {getEagleTotal()}</ListGroup.Item>
            <ListGroup.Item variant="dark">Eagles Per Round: {getEaglesPerRound()}</ListGroup.Item>
            <ListGroup.Item variant="dark">Eagles Likelihood {getEagleLikelihood()}</ListGroup.Item>
        </ListGroup>
    )
}
