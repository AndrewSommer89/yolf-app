...
const TripleBogeys = (props) => {
    ...
    return (
        <ListGroup variant="flush">
            <ListGroup.Item variant="dark">Total Triple Bogeys: {getTripleBogeyTotal()}</ListGroup.Item>
            <ListGroup.Item variant="dark">Triple Bogeys Per Round: {getTriplesPerRound()}</ListGroup.Item>
            <ListGroup.Item variant="dark">Triple Bogey Likelihood {getTripleLikelihood()}</ListGroup.Item>
        </ListGroup>
    )
}
