...
const ScoreToPar = (props) => {
    ...
    return(
        <ListGroup variant="flush">
            <ListGroup.Item variant="dark">Total Score To Par: {getScoreToParTotal()}</ListGroup.Item>
            <ListGroup.Item variant="dark">Average Score To Par: {getAverageScoreToPar()}</ListGroup.Item>
        </ListGroup>
    )
}
