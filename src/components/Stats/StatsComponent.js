...
import TotalPutts  from "./calculations/PuttsCalulcation"
...
import Bogeys from "./calculations/BogeysCalculations"
            ...
            <div>
                <Tab.Container id="stats-tabs" defaultActiveKey="#totals">
                    <Row>
                        <Col sm={4}>
                            <ListGroup>
                                <ListGroup.Item variant="dark" action href="#totals">
                                    Totals
                                </ListGroup.Item>
                                <ListGroup.Item variant="dark" action href="#scores">
                                    Average Score
                                </ListGroup.Item>
                                <ListGroup.Item variant="dark" action href="#scoreToPar">
                                    Score To Par
                                </ListGroup.Item>
                                <ListGroup.Item variant="dark" action href="#putts">
                                    Putts
                                </ListGroup.Item>
                                <ListGroup.Item variant="dark" action href="#eagles">
                                    Eagles
                                </ListGroup.Item>
                                <ListGroup.Item variant="dark" action href="#birdies">
                                    Birdies
                                </ListGroup.Item>
                                <ListGroup.Item variant="dark" action href="#pars">
                                    Pars
                                </ListGroup.Item>
                                <ListGroup.Item variant="dark" action href="#bogeys">
                                    Bogeys
                                </ListGroup.Item>
                                <ListGroup.Item variant="dark" action href="#doubles">
                                    Double Bogeys
                                </ListGroup.Item>
                                <ListGroup.Item variant="dark" action href="#triples">
                                    Triple Bogeys
                                </ListGroup.Item>
                            </ListGroup>
                        </Col>
